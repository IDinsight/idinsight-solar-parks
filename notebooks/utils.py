...
def get_steep_shapes(dem_folderpath, dem_filename: str, input_crs: int, output_crs: int, slope_type: str, plot=True):
    ...
    slope_shapes_gdf = slope_shapes_gdf.set_crs(input_crs).to_crs(output_crs)
