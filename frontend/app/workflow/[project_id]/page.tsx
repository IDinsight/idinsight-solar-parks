...
import { ChevronLeft, ChevronRight, ArrowLeft, AlertCircle, Map, Globe, Lock, ExternalLink, Link, FileSpreadsheet, Trash2, AlertTriangle, Loader2, Check, Copy } from "lucide-react"
...
function WorkflowContent() {
    ...
    const handleToggleMapVisibility = async () => {
        ...
        try {
            const updated = await api.updateProjectVisibility(currentProject.id, !currentProject.is_public)
    ...
    return (
        <main className="min-h-screen bg-slate-50 flex flex-col">
            ...
            <div className="flex-1 flex flex-col container mx-auto max-w-8xl px-6 py-6">
                ...
                {/* Content Area */}
                <div className="bg-white rounded-lg p-6 mb-4 flex-1 flex flex-col min-h-0">
                    {/* Page 1: Upload */}
                    {currentPage === 1 && (
                                    ...
                                    <div>
                                        <div className="space-y-4">
                                            ...
                                            <div className="w-full border-2 border-slate-200 rounded-lg px-4 py-4">
                                                {/* Top header: icon + title/subtitle on the left, Open on the right */}
                                                <div className="flex items-start justify-between gap-4">
                                                    ...
                                                    <button
                                                        ...
                                                        className="flex items-center gap-1.5 px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-medium rounded-md transition-colors flex-shrink-0"
                                                    >
